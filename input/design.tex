...
\newpage
{\bf Database Design}
\image{0.4}{images/design1.png}{Database Design}
\newpage
\image{0.4}{images/design2.png}{Database Design}
...
\image{0.4}{images/login.png}{Login Interface}
\newpage
\subsubsection{Project Detail}
\image{0.4}{images/project.png}{Project Detail}
\newpage
\subsubsection{Class Detail}
\image{0.4}{images/class.png}{Class Detail}
\newpage
\subsubsection{Roll No Detail}
\image{0.4}{images/rollno.png}{Roll No Detail}
\newpage
\subsubsection{Datesheet Detail}
\image{0.4}{images/datesheet.png}{Datesheet Detail}
\newpage
\subsubsection{Exam Detail}
\image{0.4}{images/exam.png}{exam Detail}
\newpage
\subsubsection{Room Detail}
\image{0.4}{images/room.png}{Room Detail}
\newpage
\subsubsection{Select Strategy}
\image{0.4}{images/strategy.png}{Select Strategy}
\newpage
\subsubsection{Validate Strategy}
\image{0.4}{images/valid.png}{Validate Strategy}
\newpage
\subsubsection{Seating Plan}
\image{0.4}{images/report.png}{Download Report}
\newpage
\subsubsection{Generated Seating Plan}
\image{0.4}{images/seatplan.png}{Generated Seating Plan}
